...
export function IncomesForm(){
    ...
    useEffect(()=>{
        const fetchData = async () => {
            try {
              ...
              const response = await fetch(`https://gestor-gastos-backend.onrender.com/api/incomes-categories`, {
                method: 'GET',
                credentials: 'include',
                headers: {
                },
    ...
    const handleSubmit = async (event)=>{
      ...
      try {
          const response = await fetch('https://gestor-gastos-backend.onrender.com/api/incomes', {
              method: 'POST',
              headers: {
                ...
                <div className='flex flex-col p-2 md:p-5 justify-around h-1/6 w-full '>
                    <div className='shadow-sm rounded-md'>
                      ...
                      <div className='flex text-center justify-center' > 
                            ...
                            <input onClick={handleSubmit} type="submit" value='Agregar Ingreso' className='text center w-full rounded-sm p-1 bg-[#F4A615] text-[#071013] hover:cursor-pointer hover:scale-105 duration-75' />
